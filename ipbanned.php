...
<style type="text/css">/*\*/@import url(www.runescape.com/layout-0/css/global-10.css);/**/</style>
...
<img src="www.runescape.com/layout-0/img/main/layout/head_image.jpg" alt="RuneScape" />
<div id="headImage"><a href="index.php" id="logo_select"></a>
<div id="player_no">Your ip has been banned</div>
<div id="lang">
...
<?php
echo "<p>Your IP Has been blocked from this site</p>";
?> 
</div>
</div> </div> </div> </div> </div>
