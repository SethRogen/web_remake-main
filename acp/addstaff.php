...
<?php
 if(isset($_SESSION['admin'])){
  ...
  $image = 'crown_silver';
    ...
    {
    mysql_query("INSERT INTO ". $prefix ."staff (position, name, image) VALUES ('". realEscape($_POST['position']) ."', '". realEscape($_POST['name']) ."', '" . realEscape($image) ."')");
    echo "You have succesfuly added a staff member. Please go to <a href='../staff.php'>staff page</a><br> to view this member!";
    }
  }
...
<option value="3">Co-Owner</option>
