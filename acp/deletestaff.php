...
if(isset($_SESSION['admin']))
 {
    ...
    {
      mysql_query("DELETE FROM {$prefix}staff WHERE id={$_GET["id"]}");
      echo "<p>You have successfully deleted that staff member.</p>
  <p>Please click <a target='_top' href='../staff.php'>here</a> to go to the staff list.</p>";
    }
    else
    {
    echo "Invalid ID";
