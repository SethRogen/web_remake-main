...
?>
<li class="top"><a class="tl" href="#"><span class="ts">Account</span><!--[if gt IE 6]><!--></a><!--<![endif]-->
...
<!--[if lte IE 6]><table><tr><td><![endif]-->
<ul>
<li><a href="acp/changenews.php" class="fly"><span>Add News</span></a></li>
<li><a href="acp/addstaff.php" class="fly"><span>Add Staff</span></a></li>
<li><a href="acp/theme.php" class="fly"><span>Change Theme</span></a></li>
<li><a href="acp/addlink.php" class="fly"><span>Add Link</span></a></li>
<li><a href="acp/deletelink.php" class="fly"><span>Delete Link</span></a></li>
<li><a href="acp/editinfo.php" class="fly"><span>Edit Info</span></a></li>
<li><a href="acp/changeurl.php" class="fly"><span>Client Settings</span></a></li>
<li><a href="acp/users.php" class="fly"><span>Users</span></a></li>
<li><a href="acp/check_version.php" class="fly"><span>Check Version</span></a></li>
</ul>
...
<li class="top"><a class="tl" href="#"><span class="ts">Game Guide</span><!--[if gt IE 6]><!--></a><!--<![endif]-->
<!--[if lte IE 6]><table><tr><td><![endif]-->
<ul>
...
<li class="top"><a class="tl" href="#"><span class="ts">Community</span><!--[if gt IE 6]><!--></a><!--<![endif]-->
<!--[if lte IE 6]><table><tr><td><![endif]-->
<ul>
<?php
 ...
 if($flink[0] == "") {
	 echo '<li><a href="forums/" class="fly"><span>Forums</span></a></li>';
...
<li class="top"><a class="tl" href="#"><span class="ts">Help</span><!--[if gt IE 6]><!--></a><!--<![endif]-->
<!--[if lte IE 6]><table><tr><td><![endif]-->
<ul>
<?php
...
{
echo '<li><a href=" " class="fly"><span>empty</span></a></li>';
}
?>
